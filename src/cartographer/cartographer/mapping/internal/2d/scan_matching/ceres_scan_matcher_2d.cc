...
void CeresScanMatcher2D::Match(
    const Eigen::Vector2d& target_translation,  // pose_prediction的平移
  ...
  //   LOG(INFO)<<"initial_pose_estimate.X:
  //   "<<initial_pose_estimate.translation().x();
  //   LOG(INFO)<<"initial_pose_estimate.Y:
  //   "<<initial_pose_estimate.translation().y();
  //   LOG(INFO)<<"initial_pose_estimate.A:
  //   "<<initial_pose_estimate.rotation().angle(); LOG(INFO)<<"After
  //   optimize..."; LOG(INFO)<<"X: "<<ceres_pose_estimate[0]; LOG(INFO)<<"Y:
  //   "<<ceres_pose_estimate[1]; LOG(INFO)<<"A: "<<ceres_pose_estimate[2];
