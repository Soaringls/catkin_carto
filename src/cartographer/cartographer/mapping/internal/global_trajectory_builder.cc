...
class GlobalTrajectoryBuilder : public mapping::TrajectoryBuilderInterface {
 public:
  ...
  // invoke by SensorBridge::HandleRangefinder(cartographer_ros)
  void AddSensorData(
    ...
    std::unique_ptr<typename LocalTrajectoryBuilder::MatchingResult>
        // local_trajectory_builder_ 即local_trajectory_builder2d/3d
  ...
  // invoke by SensorBridge::HandleImuMessage
